...
userScheema.methods.matchPassword = async (enteredPassword, hashPassword) => {
  /* console.log(enteredPassword); */
  try {
    /* this.password = await this.password;
    console.log(this.password); */
    const isPassword = await bcrypt.compare(enteredPassword, hashPassword);
    /*  console.log(isPassword); */
    return isPassword;
  } catch (error) {
    console.log("Error in match Password", error);
  }
};
